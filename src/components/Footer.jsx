...
const socialLinks = [
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/Dipak-K-Patil' },
  { icon: <LinkedInIcon />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/dipak-patil01/' },
  { icon: <LanguageIcon />, label: 'Portfolio', href: '' },
  { icon: <EmailIcon />, label: 'Email', href: 'mailto:dipakpatil9773@gmail.com' },
];
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
          <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.7)' }}>
            © {new Date().getFullYear()} Fusion Electronics. Crafted in India & powered worldwide.
          </Typography>

...
echo "🚀 Publishing @https://github.com/Dipak-K-Patil/ecommerce-fullstack-website-frontend to GitHub Packages..."
npm publish --access public

# 3) Friendly confirmation
NAME=$(node -p "require('./package.json').name")
VERSION=$(node -p "require('./package.json').version")
echo "✅ Published ${NAME}@${VERSION} to https://github.com/Dipak-K-Patil"
